                                                                ...
                                                                <center>
                                                                    <div class="dropify-wrapper has-preview">
                                                                        ...
                                                                        <input type="file" id="input-file-max-fs"
                                                                            class="dropify"
                                                                            data-default-file="<?php echo $profile_pic ?>"
                                                                            name="image"
                                                                            data-max-file-size="2M" /><button
                                                                            type="button" class="dropify-clear">
                                                                            <i class="flaticon-close-fill"></i>
                                                                        </button>
                                                                        <div class="dropify-preview"
                                                                            style="display: block">
                                                                            <span class="dropify-render"><img
                                                                                    src="<?php echo $profile_pic ?>" /></span>
                                                                            <div class="dropify-infos">
                                                                                <div class="dropify-infos-inner">
                                                                                    <p class="dropify-filename">
                                                                                        <span class="file-icon"></span>
                                                                                        <span
                                                                                            class="dropify-filename-inner">9909192309IMG-20250614-WA0370.jpg</span>
                                                                                    </p>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                ...
                                                                                value="<?php echo $account_type ?>" readonly="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                placeholder="" value="<?php echo $occupation ?>"
                                                                                readonly="" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control mb-4 text-capitalize"
                                                                                placeholder="Ocuppation" value="<?php echo $gender ?>"
                                                                                readonly="" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="profession">Registered On</label></label>
                                                                            <input type="text"
                                                                                class="form-control mb-4 text-capitalize"
                                                                                id="profession"
                                                                                placeholder="Date Of Birth"
                                                                                value="<?php echo $date_created ?> " readonly="" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
