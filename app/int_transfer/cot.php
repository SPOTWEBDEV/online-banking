                                ...
                                <div class="user-profile">
                                    ...
                                    <form action="" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="text-center text-info text-uppercase">HELLO, <?php echo $fullname  ?>
                                                    KINDLY INSERT YOUR COT CODE TO FACILITATE THE TRANSFER OF YOUR FUNDS
                                                </p>
                                        ...
                                        <div class="row mb-4 mt-4">
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <div class="input-group ">
                                                        <input type="number" class="form-control" name="cot_code"
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="form-group ">
                                                    <button class="btn btn-primary col-12" name="cot_submit">Continue
                                                        Transfer </button>
                                                </div>
                                            </div>
                                        </div>
            ...
            if ($inputed_cot == $cot){
                    ...
                    echo "<script>
                        Swal.fire({
                            ...
                            text: 'Your transaction is pending. Please confirm Imf.',
                            confirmButtonText: 'Proceed'
                        }).then(() => {
                            window.location.href = \"imf.php?id={$transfer_id}&table=transfer\";
                        });
                    </script>";
                ...
                echo "<script>
                    Swal.fire({
                        ...
                        text: ' incorrect cot Please try again.'
                    });
                </script>";
