...
<head>
    ...
    <title>Cost of Transfer - <?php echo  $sitename ?> </title>
                            ...
                            <div class="card-body">
                                <div class="user-profile">
                                    ...
                                    <form action="" method="post">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="text-center text-info text-uppercase">HELLO, <?php echo $fullname  ?>
                                                    KINDLY INSERT YOUR tax CODE TO FACILITATE THE TRANSFER OF YOUR FUNDS
                                                </p>
                                        ...
                                        <div class="row mb-4 mt-4">
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <div class="input-group ">
                                                        <input type="number" class="form-control" name="tax_code"
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="form-group ">
                                                    <button class="btn btn-primary col-12" name="tax_submit">Continue
                                                        Transfer </button>
                                                </div>
                                            </div>
                                        </div>
            ...
            if ($inputed_tax == $tax){
                    ...
                    echo "<script>
                        Swal.fire({
                            ...
                            text: 'Your transaction is pending. Please confirm Otp code.',
                            confirmButtonText: 'Proceed'
                        }).then(() => {
                        
                           window.location.href = \"../otp_confirm/index.php?id={$transfer_id}&table=transfer\";
                ...
                echo "<script>
                    Swal.fire({
                        ...
                        text: ' incorrect tax code Please try again.'
                    });
                </script>";
