          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
              <div class="widget widget-table-two">
                  ...
                  <div class="widget-heading">
                      <h5 class="">Deposit Transactions</h5>
                  </div>
                          ...
                          <table class="table">
                              <thead>
                                  <tr>
                                      ...
                                      <th><div class="th-content">PAYMENT_METHOD</div></th>
                              ...
                              <tbody>
                                  <?php
                                  $query = "SELECT * FROM deposit WHERE user = $id";
                                  ...
                                  if ($result->num_rows > 0) {
                                      ...
                                      while ($row = $result->fetch_assoc()) {
                                          ...
                                          $method = getPaymentTypeName($connection, $row['payment_type']);
                                          ...
                                          <tr>
                                              ...
                                              <td><div class='td-content product-invoice'>" . htmlspecialchars($method) . "</div></td>
                                              <td><div class='td-content product-invoice'>" . htmlspecialchars($formatted_date) . "</div></td>
                                              <td><div class='td-content'><span>$badge</span></div></td>
                                          </tr>
                                          ";
                                      }
                                  } else {
                                      echo "<tr><td colspan='5' class='dataTables_empty'>No transactions found for this user.</td></tr>";
                                  }
                                  ?>
                              </tbody>
                          </table>
            ...
            <div class="widget-content">
              <div class="row g-3">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exchange-amount" placeholder="Enter amount" />
                  </div>
                </div>
              ...
              <script>
                async function convertCurrency() {
                  ...
                  if (!amount || amount <= 0) {
                    resultBox.innerHTML = `<span class="text-danger">Please enter a valid amount.</span>`;
                    return;
                  }

                  if (!from || !to) {
                    resultBox.innerHTML = `<span class="text-danger">Please select both currencies.</span>`;
                    return;
                  }
                  ...
                  try {
                    ...
                    if (data.result !== undefined) {
                      resultBox.innerHTML = `${amount} ${from} = <span class="text-primary">${data.result.toFixed(2)} ${to}</span>`;
                    } else {
                      resultBox.innerHTML = `<span class="text-danger">Could not fetch conversion rate.</span>`;
                    }
                  } catch (error) {
                    resultBox.innerHTML = `<span class="text-danger">Error fetching exchange rate. Please try again later.</span>`;
                  }
                }
              </script>
            </div>
