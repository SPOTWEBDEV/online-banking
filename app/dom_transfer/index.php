                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                              <div class="form-group mb-4 mt-4">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="amount" value="" placeholder="Amount" aria-label="notification" aria-describedby="basic-addon1" required>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group mb-4 mt-4">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" name="acct_name" placeholder="Beneficiary Account Name" aria-label="notification" aria-describedby="basic-addon1" value="" required>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4 mt-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" name="acct_number" placeholder="Beneficiary Account Number" aria-label="notification" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group mb-4 mt-4">
                                ...
                                <div class="input-group">
                                  <select id="accountType" class="form-control" name="account_type" required>
                                    <option value="" disabled selected>Select Account Type</option>
                                    <option value="savings">Savings Account</option>
                                    <option value="current">Current Account</option>
                                    <option value="checking">Checking Account</option>
                                    <option value="fixed">Fixed Deposit</option>
                                    <option value="nra">Non Resident Account</option>
                          ...
                          <div class="row">
                            <div class="col-md-12 text-center">
                              <button class="btn btn-primary mb-2 mr-2" name="domestic-transfer">
...
if (isset($_POST['domestic-transfer'])) {
    ...
    // Assuming $balance and $account_limit are defined somewhere before these checks
    ...
    $query = "INSERT INTO `transfer` 
                  (`user`, `amount`, `type`, `description`, `date`, `time`, `status`, 
                  `sender_name`, `otp_code`, `receiver_bank`, `receiver_account_number`, 
                  `receiver_account_type`, `receiver_name`) 
                VALUES (?, ?, 'debit', ?, ?, ?, 'cancelled', ?, ?, ?, ?, ?, ?)";

    if ($stmt = mysqli_prepare($connection, $query)) {
        // Bind parameters
        // Types:
        // i - integer (user id, sms_code)
        // d - double (amount)
        // s - string (all others)
        mysqli_stmt_bind_param(
            ...
            $acct_remarks, // description (string)
            $date,         // date (string)
            $time,         // time (string)
            $acct_name,    // sender_name (string)
            $sms_code,     // otp_code (integer)
            $bank_name,    // receiver_bank (string)
            $acct_number,  // receiver_account_number (string)
            $account_type, // receiver_account_type (string)
            $acct_name     // receiver_name (string)
        );
