<?php include("<?php echo $domain ?>server/connection.php") ?>
<!DOCTYPE html>
<html lang="en">

<!-- Mirrored from santaaccessfinance.net/signup/verify-registration.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Jul 2025 22:34:07 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo $domain ?>asset/img/favicon.ico" />
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&amp;display=swap" rel="stylesheet">
    <link href="<?php echo $domain ?>bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>asset/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>extra/formcss.css" rel="stylesheet" type="text/css" />

    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo $domain ?>asset/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $domain ?>asset/css/forms/switches.css">


    <!-- BEGIN THEME GLOBAL STYLES -->
    <link href="<?php echo $domain ?>asset/css/scrollspyNav.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>plugins/animate/animate.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>plugins/notification/snackbar/snackbar.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $domain ?>asset/css/elements/alert.css">
    <script src="<?php echo $domain ?>plugins/sweetalerts/promise-polyfill.js"></script>
    <link href="<?php echo $domain ?>plugins/sweetalerts/sweetalert2.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>plugins/sweetalerts/sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $domain ?>asset/css/components/custom-sweetalert.css" rel="stylesheet" type="text/css" />
    <script src="<?php echo $domain ?>asset/js/libs/jquery-3.1.1.min.js"></script>
    <!-- Toastr CSS -->
...
<body>
    ...
    <script src="<?php echo $domain ?>bootstrap/js/popper.min.js"></script>
    <script src="<?php echo $domain ?>bootstrap/js/bootstrap.min.js"></script>
    <script src="<?php echo $domain ?>plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="<?php echo $domain ?>asset/js/app.js"></script>

    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="<?php echo $domain ?>asset/js/authentication/form-2.js"></script>
    <script src="<?php echo $domain ?>plugins/highlight/highlight.pack.js"></script>
    <script src="<?php echo $domain ?>asset/js/custom.js"></script>
    <!-- END GLOBAL MANDATORY STYLES -->
    <script src="<?php echo $domain ?>plugins/notification/snackbar/snackbar.min.js"></script>
    <!-- END PAGE LEVEL PLUGINS -->

    <!--  BEGIN CUSTOM SCRIPTS FILE  -->
    <script src="<?php echo $domain ?>asset/js/components/notification/custom-snackbar.js"></script>
    <!--  END CUSTOM SCRIPTS FILE  -->

    <!-- BEGIN THEME GLOBAL STYLE -->
    <script src="<?php echo $domain ?>asset/js/scrollspyNav.js"></script>
    <script src="<?php echo $domain ?>plugins/sweetalerts/sweetalert2.min.js"></script>
    <script src="<?php echo $domain ?>plugins/sweetalerts/custom-sweetalert.js"></script>
    <script src="<?php echo $domain ?>extra/formjs.js"></script>
