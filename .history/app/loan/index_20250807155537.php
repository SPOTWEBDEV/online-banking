...
<head>
    ...
    <title>Loan - <?php echo  $sitename ?> </title>
                                        ...
                                        <div class="col-md-12">
                                                            ...
                                                            <div class="input-group ">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text"
                                                                        id="basic-addon1"><?php  echo $currency_type  ?></span>
                                                                </div>
                                                        ...
                                                        <div class="form-group mb-4 mt-4">
                                                            ...
                                                            <div class="input-group ">
                                                                <textarea class="form-control mb-4" rows="3"
                                                                    ...
                                                                    name="loan_remarks"required ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 text-center">
                                                        <button class="btn btn-primary mb-2 mr-2"
                                                            name="loan-submit"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <?php
                                                if (isset($_POST['loan-submit'])) {
                                                    // Sanitize input
                                                    $description = trim($_POST['loan_remarks']);
                                                    $amount = floatval($_POST['amount']);
                                                    $date = date('Y-m-d');
                                                    $time = date('H:i:s');

                                                    // Use prepared statements to prevent SQL injection
                                                    $stmt = $connection->prepare("INSERT INTO `loan` (`user`, `amount`, `description`, `status`, `time`, `date`, `type`) 
                                                                                VALUES (?, ?, ?, 'pending', ?, ?, 'credit')");
                                                    $stmt->bind_param("sdsss", $id, $amount, $description, $time, $date);

                                                    if ($stmt->execute()) {
                                                        echo "<script>
                                                            Swal.fire({
                                                                icon: 'success',
                                                                title: 'Loan Initialized',
                                                                text: 'Your transaction is pending. Awaiting approval.',
                                                        ...
                                                        echo "<script>
                                                            Swal.fire({
                                                                icon: 'error',
                                                                title: 'Loan Failed!',
                                                                text: 'You are unable to request a loan at this moment.'
                                                            });
                                                        </script>";
                                                    }
