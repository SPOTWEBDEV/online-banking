            ...
            <div class="layout-px-spacing">
                                            ...
                                            <table id="default-ordering" class="table table-hover dataTable"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 188px;">Bank Name</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php  
                                                        ...
                                                        $stmp = $connection->query("SELECT * FROM bank_list");
                                                        ...
                                                        if (isset($_GET['del'])) {
                                                            $del_id = $_GET['del'];
                                                            $delete_query = "DELETE FROM bank_list WHERE id='$del_id'";
                            ...
                            <div class="modal-content">
                                ...
                                <?php 
                                                    ...
                                                    if (isset($_POST['crypto_save'])) {
                                                        ...
                                                        $insert_query = "INSERT INTO bank_list(name) VALUES ('$crypto_name')";
                                                        if ($connection->query($insert_query) === TRUE) {
                                                            echo "<script>toastr.success('Bank added successfully!');</script>";
                                                        echo "<script>setTimeout(function() { location.href = '' ; }, 2000);</script>";
                                                            
                                                        } else {
                                                            echo "<script>toastr.error('Error adding bank: " . $connection->error . "');</script>";
                                                        }
                                                    }
                ...
                <div class="footer-wrapper">
                    <div class="footer-section f-section-1">
                        <p class="">Copyright © <script>document.write( new Date().getFullYear())</script> <a target="_blank" href="/"><?php echo  $sitename ?></a>, All rights
                            reserved.</p>
                    </div>
                    <div class="footer-section f-section-2">
                        <p class=""><?php echo  $sitename ?> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather xfeather-heart">
                                <path
