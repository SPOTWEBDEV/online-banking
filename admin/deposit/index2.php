...
<body class="dashboard-analytics">
    ...
    <div class="main-container" id="container">
        ...
        //             type: "success",
        //             title: "Saved",
        //             text: "Crypto Saved Successfully",
        //             padding: "2em"
        //         })
        //     });
        // </script>
                                ...
                                <div id="default-ordering_wrapper"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="dataTables_length" id="default-ordering_length"><label>Results :
                                                    <select name="default-ordering_length"
                                            ...
                                            <table id="default-ordering" class="table table-hover dataTable"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0"
                                                            ...
                                                            style="width: 69px;">S/N</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Crypto Name: activate to sort column ascending"
                                                            style="width: 188px;">Crypto Name</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Wallet Address: activate to sort column ascending"
                                                            style="width: 461px;">Wallet Address</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Date: activate to sort column ascending"
                                                            style="width: 197px;">Date</th>
                                                        <th class="text-center dt-no-sorting sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 111px;">Action</th>
                                                        <th hidden="" class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php  
                                                        ...
                                                        $stmp = $connection->query("SELECT * FROM payment_details_crypto");
                                                        $result = mysqli_fetch_all($stmp, MYSQLI_ASSOC);
                                                        $count = 1;
                                                        foreach ($result as $row) {
                                                            echo '<tr role="row">
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a class="btn btn-primary edit-crypto" 
                                                                           data-name="' . htmlspecialchars($row['name']) . '" 
                                                                           data-wallet-address="' . htmlspecialchars($row['address']) . '" 
                                                                           data-id="' . $row['id'] . '">Edit</a>
                                                                    </td>
                                                                    <td>

                                                                        <a href="?del=' . $row['id'] . '" class="btn btn-danger delete-crypto">Delete</a>
                                                        ...
                                                        if (isset($_GET['del'])) {
                                                            $del_id = $_GET['del'];
                                                            $delete_query = "DELETE FROM payment_details_crypto WHERE id='$del_id'";
                                                            if ($connection->query($delete_query) === TRUE) {
                                                                echo "<script>toastr.success('Crypto Deleted Successfully'); </script>";
                                                                echo "<script>setTimeout(function() { location.href = '' ; }, 2000);</script>";
                                                            } else {
                                                                echo "<script>toastr.error('Error deleting crypto');</script>";
                                                            }
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">Crypto Name</th>
                                                        <th rowspan="1" colspan="1">Wallet Address</th>
                                                        <th rowspan="1" colspan="1">Date</th>
                                                        <th class="text-center dt-no-sorting" rowspan="1" colspan="1">
                                                            Action</th>
                            ...
                            <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mx-auto">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-4" name="crypto_name"
                                                        placeholder="Crypto Name" value="" required=""
                                                        autocomplete="off">
                                                </div>
                                                <div class="form-group">
                                                    <label>Wallet Address</label>
                                                    <input type="text" class="form-control mb-4" name="wallet_address"
                                                        placeholder="Wallet Address" value="" required=""
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php 
                                                    ...
                                                    if (isset($_POST['crypto_save'])) {
                                                        ...
                                                        $insert_query = "INSERT INTO payment_details_crypto (name, address,`date`) VALUES ('$crypto_name', '$wallet_address' , '$date')";
                                                        if ($connection->query($insert_query) === TRUE) {
                                                            echo "<script>toastr.success('Crypto added successfully!');</script>";
                                                        echo "<script>setTimeout(function() { location.href = '' ; }, 2000);</script>";
                                                            
                                                        } else {
                                                            echo "<script>toastr.error('Error adding crypto: " . $connection->error . "');</script>";
                                                        }
                                                    }
                            ...
                            <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mx-auto">
                                                <div class="form-group">
                                                    <label>Crypto Name</label>
                                                    <input type="text" class="form-control mb-4" name="crypto_name"
                                                        id="crypto_name" placeholder="Crypto Name" required=""
                                                        autocomplete="off">
                                                </div>
                                                <div class="form-group">
                                                    <label>Wallet Address</label>
                                                    <input type="text" class="form-control mb-4" name="wallet_address"
                                                        placeholder="Wallet Address" id="wallet_address" value=""
                                                        required="" autocomplete="off">
                                                </div>
                                                <input type="hidden" name="crypto_id" id="crypto_id" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                ...
                                <?php 
                                                    ...
                                                    if (isset($_POST['crypto_edit'])) {
                                                        ...
                                                        $update_query = "UPDATE payment_details_crypto SET name='$crypto_name', address='$wallet_address' WHERE id='$crypto_id'";
                                                        if ($connection->query($update_query) === TRUE) {
                                                            echo "<script>toastr.success('Crypto updated successfully!');</script>";
                                                            echo "<script>setTimeout(function() { location.href = ''; }, 2000);</script>";
                                                            
                                                        } else {
                                                            echo "<script>toastr.error('Error updating crypto: " . $connection->error . "');</script>";
                                                        }
                                                    } 
    ...
    $(document).ready(function () {
        ...
        $('.edit-crypto').on('click', function () {
            ...
            var address = $(this).data('wallet-address');
            var id = $(this).data('id');

            // Set form fields
            $('#crypto_name').val(name);
