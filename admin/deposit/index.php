                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 offset-md-3  layout-spacing">
                                        ...
                                        <?php
                                                ...
                                                $stmp = $connection->prepare("SELECT * FROM payment_details_bank");
                                                $stmp->execute();
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" value="<?php echo htmlspecialchars($row['bank_name']); ?>" name="bank_name" autocomplete="off" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" value="<?php echo htmlspecialchars($row['routine_number']); ?>" name="routine_no" autocomplete="off" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" value="<?php echo htmlspecialchars($row['acount_number']); ?>" name="acct_no" autocomplete="off" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" value="<?php echo htmlspecialchars($row['swift_code']); ?>" name="swift_code" autocomplete="off" required>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<div class="alert alert-warning text-center">No bank details found.</div>';
                                                }
...
<?php
        ...
        if (isset($_POST['save_deposit'])) {
            ...
            $stmt = $connection->prepare("UPDATE payment_details_bank SET bank_name=?, routine_number=?, acount_number=?, swift_code=? WHERE id=1");
            $stmt->bind_param("ssss", $bank_name, $routine_no, $acct_no, $swift_code);

            if ($stmt->execute()) {
                echo '<script>toastr.success("Bank details updated successfully!");</script>';
            } else {
                echo '<script>toastr.error("Error updating bank details.");</script>';
            }
