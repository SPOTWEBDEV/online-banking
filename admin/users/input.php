...
<html lang="en" data-select2-id="37">
...
<body class="dashboard-analytics">
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing" data-select2-id="36">
                <div class="row layout-top-spacing" data-select2-id="35">

                    <div id="basic" class="col-lg-12 layout-spacing" data-select2-id="basic">
                        <div class="statbox widget box box-shadow" data-select2-id="34">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-12 mx-auto">
                                        <form method="post" data-select2-id="33">
                                            ...
                                            <div class="row" data-select2-id="32">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input value="" type="text" name="sender_name"
                                                            class="form-control" id="" placeholder="From" required=""
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input value="" type="number" name="amount" class="form-control"
                                                            id="" placeholder="Amount" required="" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea name="description" class="form-control"
                                                            placeholder="Decription" required=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="time" name="time_created" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 text-center">
                                                    <button name="credit" type="submit"
                                                        class="btn btn-primary mt-3 col-md-12">Credit User</button>

                                                </div>
                                                <div class="col-md-6 text-center">
                                                    <button name="debit" type="submit"
                                                        class="btn btn-danger mt-3 col-md-12">Debit User</button>
    ...
    if (isset($_POST['credit'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $update = $connection->prepare("INSERT INTO `transfer`(`user`, `amount`, `type`, `sender_name`, `description`, `date`, `time` , `status`) VALUES (?, ?, 'credit', ?, ?, ?, ? , 'approved')");
            $update->bind_param("idssss", $user_id, $amount, $sender_name, $description, $created_at, $time_created);
            if ($update->execute()) {
                ...
                if ($update_balance->execute()) {
                    echo "<script>toastr.success('User credited successfully.');</script>";
                } else {
                    echo "<script>toastr.error('Failed to update user balance.');</script>";
                }
            } else {
                echo "<script>toastr.error('Failed to credit user.');</script>";
            }
    ...
    if (isset($_POST['debit'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($amount > $current_balance) {
                echo "<script>toastr.error('Insufficient balance to debit this amount.');</script>";
                exit;
            }else{

                $update = $connection->prepare("INSERT INTO `transfer`(`user`, `amount`, `type`, `sender_name`, `description`, `date`, `time` , `status`) VALUES (?, ?, 'debit', ?, ?, ?, ? , 'approved')");
                $update->bind_param("idssss", $user_id, $amount, $sender_name, $description, $created_at, $time_created);
                if ($update->execute()) {
                    $update_balance = $connection->prepare("UPDATE users SET balance = ? WHERE id = ?");
                    $update_balance->bind_param("di", $balance, $user_id);
                    ...
                    if ($update_balance->execute()) {
                        echo "<script>toastr.success('User Debited successfully.');</script>";
                    } else {
                        echo "<script>toastr.error('Failed to update user balance.');</script>";
                    }
                } else {
                    echo "<script>toastr.error('Failed to Debit user.');</script>";
                }
