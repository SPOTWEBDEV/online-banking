                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 247.672px;">ACCOUNT EMAIL</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                    ...
                                                    <?php  
                                                            ...
                                                            while ($row = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo "<tr role='row'>
                                                                        ...
                                                                        <td>$email</td>
                                                                        <td class='text-center'><a href='./edit.php?id=$id' class='btn btn-primary'>View</a></td>
                                                                    </tr>";
