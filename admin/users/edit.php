                                    ...
                                    <div class="info">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-4 mx-auto">
                                          <div class="form-group">
                                            <button class="btn btn-danger mb-4 disabled"  style=" font-weight: bold;">
                                              CURRENT STATUS: <b><?php  echo $user['status']   ?></b>
                                            </button>
                                            <br>
                                          ...
                                          <?php 
                                              ...
                                              if (isset($_POST['status_submit'])) {
                                                  ...
                                                  $update_statment = $connection->prepare("UPDATE users SET status = ? WHERE id = ?");
                                                  $update_statment->bind_param("si", $acct_status, $user_id);
                                                  if($update_statment->execute()) {
                                                      echo "<script>toastr.success('Account status updated successfully!');</script>";
                                                      echo "<script>setTimeout(function(){ window.location.href = 'edit.php?id=$user_id'; }, 2000);</script>";
                                                  } else {
                                                    echo "<script>toastr.error('Failed to update account status.');</script>";
                                                     echo "<script>setTimeout(function(){ window.location.href = 'edit.php?id=$user_id'; }, 2000);</script>";
                                                  }
                                              }
                                          ...
                                          <?php 
                                              ...
                                              if (isset($_POST['billing_code'])) {
                                                  $acct_status = $_POST['billing_type'];
                                                  $update_statment = $connection->prepare("UPDATE users SET billing_status = ? WHERE id = ?");
                                                  $update_statment->bind_param("si", $acct_status, $user_id);
                                                  if($update_statment->execute()) {
                                                      echo "<script>toastr.success('Account status updated successfully!');</script>";
                                                      echo "<script>setTimeout(function(){ window.location.href = 'edit.php?id=$user_id'; }, 2000);</script>";
...
<!-- activating or deactivating user profile  -->
