            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    ...
                    <?php
                        ...
                        $total_pending_transfer = mysqli_num_rows(mysqli_query($connection,"SELECT * FROM `transfer` WHERE `status`='pending'"));
                        ...
                        <div class="widget widget-account-invoice-two">
                            <div class="widget-content">
                                <div class="account-box">
                                    <div class="info">
                                        <h5 class="">Total Pending Transfer</h5>
                                        <p class="inv-balance"><?php echo $total_pending_transfer ?></p>
                                    </div>
