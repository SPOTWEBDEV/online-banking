                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    ...
                                    <?php 
                                            ...
                                            $statment  = mysqli_query($connection,"SELECT * FROM `transfer` WHERE `id`='$transaction_id'");
                                        ...
                                        <div class="info">
                                                ...
                                                <div class="col-md-8 offset-md-2 table-responsive">
                                                    <table class="table table-bordered mb-4">
                                                        <tbody>
                                                            <tr>
                                                                <th>Name</th>
                                                                <th><?php  echo $data['receiver_name']  ?></th>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <th>Transfer Type</th>
                                                                <?php if ($data['type'] == "debit") { echo "<td><span class='text-danger'>Debit</span></td>"; } else { echo "<td><span class='text-success'>Credit</span></td>"; } ?>
                                                            </tr>
                                                            <tr>
                                                                <th>Sender Name</th>
                                                                <th><?php  echo $data['sender_name']  ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th>Description</th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 offset-md-2">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <button class="btn btn-success col-md-12 mb-2"
                                                                name="accept">Confirm</button>
                                                        </div>
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button class="btn btn-danger col-md-12 mb-2" name="del">Delete</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <?php
                                                                    ...
                                                                    if (isset($_POST['del'])) {
                                                                        ...
                                                                        $statment = mysqli_query($connection,"DELETE FROM `transfer` WHERE `id` = '$id' ");
                                                                        ...
                                                                        if ($statment){
                                                                            ...
                                                                            echo "<script>  toastr.error('unable to delete.');   </script>";
                                                                    ...
                                                                    if (isset($_POST['accept'])){
                                                                        ...
                                                                        $statment = mysqli_query($connection ,"UPDATE `transfer` SET `status`='approved'  WHERE `id` = '$id'");
                                                                        ...
                                                                        if ($statment){
                                                                            ...
                                                                            echo "<script>  toastr.error('unable to confirm.');   </script>";
                                                                        }
                                                                    ...
                                                                    if (isset($_POST['decline'])) {
                                                                        ...
                                                                        if ($user > 0 && $amount > 0 && $id > 0) {
                                                                            ...
                                                                            if ($stmt = mysqli_prepare($connection, $query)) {
                                                                                ...
                                                                                // 2. Add amount back to user's balance
                                                                                $new_balance = $current_balance + $amount;

                                                                                // 3. Update user's balance
                                                                                $update_user = "UPDATE users SET balance = ? WHERE id = ?";
                                                                                if ($stmt = mysqli_prepare($connection, $update_user)) {
                                                                                    mysqli_stmt_bind_param($stmt, 'di', $new_balance, $user);
                                                                                    mysqli_stmt_execute($stmt);
                                                                                    mysqli_stmt_close($stmt);
                                                                                }

                                                                                // 4. Update transfer status to 'declined'
                                                                                $update_transfer = "UPDATE transfer SET status = 'declined' WHERE id = ?";
                                                                                if ($stmt = mysqli_prepare($connection, $update_transfer)) {
                                                                                ...
                                                                                echo "<script>
                                                                                    Swal.fire({
                                                                                        icon: 'error',
                                                                                        title: 'Error',
                                                                                        text: 'Unable to fetch user balance.'
                                                                                    });
                                                                                </script>";
                                                                            }
                                                                        } else {
