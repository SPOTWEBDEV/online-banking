                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0"
                                                            ...
                                                            style="width: 36px;">S/N</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="NAME: activate to sort column ascending"
                                                            style="width: 167px;">NAME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="AMOUNT: activate to sort column ascending"
                                                            style="width: 75px;">AMOUNT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="TRANS TYPE: activate to sort column ascending"
                                                            style="width: 104px;">TRANS TYPE</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="SENDER NAME: activate to sort column ascending"
                                                            style="width: 296px;">SENDER NAME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="DATE: activate to sort column ascending"
                                                            style="width: 88px;">DATE</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="TIME: activate to sort column ascending"
                                                            style="width: 78px;">TIME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Edit: activate to sort column ascending"
                                                            style="width: 96px;">Edit</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71px;">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <?php 
                                                            ...
                                                            $statment = mysqli_query($connection,"SELECT transfer.id AS transaction_id, users.id AS user_id, transfer.*, users.* FROM transfer JOIN users ON transfer.user = users.id
");
                                                            if (mysqli_num_rows($statment)  > 0){

                                                                $count = 0;
                                                                while ($data = mysqli_fetch_assoc($statment)) {$count++; ?>
                                                                        ...
                                                                        <tr role="row">
                                                                            ...
                                                                            <td><?php  echo  $data['currency'],$data['amount']  ?></td>
                                                                             ...
                                                                             <?php 
                                                                                    ...
                                                                                    if ($data['type'] == "debit"){
                                                                                            ...
                                                                                            echo "<td><span class='text-danger'>Debit</span></td>";

                                                                                    }else{

                                                                                        echo "<td><span class='text-success'>Credit</span></td>";
                                                                            ...
                                                                            <!--<td class="text-center"><a href="./view-trans.php?id=6885086b16f3a" class="btn btn-primary">View</a> </td>-->
                                                                            <td class="text-center"><a href="./edit.php?id=<?php  echo $data['transaction_id']  ?>"
                                                                                    target="_blank" class="btn btn-primary">Edit</a> </td>
                                                                            <td class="text-center"><a href="./view.php?id=<?php  echo $data['transaction_id']  ?>&user=<?php  echo $data['user_id']  ?>&amount=<?php  echo $data['amount']  ?>"
