    ...
    <div class="main-container" id="container">
                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                value="<?php  echo $data['sender_name']  ?>"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                placeholder="" value="<?php  echo $data['description']  ?>"
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date" class="form-control mb-4"
                                                                                id="profession" 
                                                                                value="<?php  echo $data['date']  ?>" name="created_at"
                                                                                autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="time" class="form-control mb-4"
                                                                                placeholder="" value="<?php  echo $data['time']  ?>"
                                                                                name="time_created" autocomplete="off">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <button class="btn btn-primary text-center"
                                                                    name="update_trans">Update</button>
                                                            ...
                                                            <?php
                                                                    ...
                                                                    if (isset($_POST['update_trans'])){
                                                                        ...
                                                                        $time  = $_POST['time_created'];

                                                                        $statment = mysqli_query($connection ,"UPDATE `transfer` SET `amount`='$amount',`description`='$description',`date`='$date',`time`='$time' , `sender_name`='$sender_name' WHERE `id` = '$transaction_id'");
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2022 <a target="_blank" href="/"><?php echo $sitename ?></a>, All rights reserved.
                </p>
            </div>
