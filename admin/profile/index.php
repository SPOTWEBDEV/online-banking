                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <center>
                                                                    <div class="dropify-wrapper has-preview">
                                                                        <div class="dropify-message"><span
                                                                            ...
                                                                            <p class="dropify-error">Ooops, something
                                                                                wrong appended.</p>
                                                                        </div>
                                                                        ...
                                                                        <div class="dropify-errors-container">
                                                                            <ul></ul>
                                                                        </div><input type="" id="input-file-max-fs"
                                                                            class="dropify"
                                                                            data-default-file="../assets/profile/jamesavatar.png"
                                                                        ...
                                                                        <div class="dropify-preview"
                                                                            style="display: block;"><span
                                                                                class="dropify-render"><img
                                                                                    src="../source/assets/profile/jamesavatar.png"></span>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    value="<?php echo $username    ?>" name="acct_name"
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($_POST['profile'])) {
                                                                ...
                                                                if (empty($email) || empty($acct_name)) {
                                                                    echo "<script>toastr.error('Please fill all fields');</script>";
                                                                } else {
                                                                    $update = $connection->query("UPDATE `admin` SET email='$email', username='$acct_name' WHERE id='$id'");
                                                                    if ($update) {
                                                                        echo "<script>toastr.success('Profile updated successfully');</script>";
                                                                        // Redirect to the same page to refresh the profile data
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="row">
                                                <div class="col-md-11 mx-auto">
                                                    ...
                                                    <div class="form-group">
                                                        <button class="btn btn-primary" name="change_password"> Change
                                                            Password</button>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            if (isset($_POST['change_password'])) {
                                                                ...
                                                                if (empty($old_password) || empty($new_password) || empty($confirm_password)) {
                                                                    ...
                                                                    if ($old_password === $password) {
                                                                        // Update the password
                                                                        $update_pass = $connection->query("UPDATE `admin` SET `password`='$new_password' WHERE id='$id'");
                                                                        if ($update_pass) {
